...
brew 'xplr'         # Directory browser in rust
...
brew 'difftastic'   # Diff that understands syntax (better diff)
...
brew 'zq'           # JSON parser (another one)
brew 'yq'           # YAML parser, output and query files
brew 'fq'           # BIN parser, output and query files
...
brew 'mdcat'                 # Fancy cat for Markdown
brew 'hexyl'                 # Hex Viewer
brew 'imdl'                  # Torrent metainfo utility
brew 'lemmeknow'             # Fastest way to identify anything!
brew 'atuin'                 # Improved shell history with sqlite
...
brew 'kubeshark'             # Tcpdump/Wireshark for K8s
brew 'fairwindsops/tap/nova' # Manage Helm release
